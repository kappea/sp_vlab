...
class SignupForm(authtoolsforms.UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML('<a href="{% url \'rcd:huisregels\' %}" target="_blank" class="external" aria-label="Toon de huisregels (opent externe website)">Toon de huisregels</a>'),
            HTML('<p>&nbsp;</p>'),
